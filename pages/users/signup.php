        ...
        if(!empty($user) && !empty($pass) && !empty($passC) && !empty($mail) && !empty($mailC)) {
            if($pass === $passC) {
                if($mail === $mailC) {
                    ...
                    ?>
                    <div class="danger">
                        Erreur : E-mail et Confirmation d'E-mail ne sont pas identiques.
                    </div>
                    <?php
                }
            } else {
                ?>
                <div class="danger">
                    Erreur : Mot de passe et Confirmation de Mot de passe ne sont pas identiques.
                </div>
                <?php
            }
        } else {
...
<div class="signup">
    ...
    <form method="post" class="add">
        ...
        <?= $form->input('emailC', 'Confirmer l\'E-mail',['type' => 'email']); ?>
