...
class GameTable extends Table {
	...
	/**
	 * Récupère tous les jeux dans la base de données et les arrange en fonction du titre
	 * 
	 * @return object
	 */
	...
	/**
	 * Récupère les 6 derniers jeux ajoutés
	 * 
	 * @return array
	 */
	...
	/**
	 * Récupère les derniers jeux de la plateforme demandée
	 * 
	 * @param $plat_id int
	 * @return array
	 */
	...
	/**
	 * Récupère les derniers jeux de la catégorie demandée
	 * 
	 * @param $cat_id int
	 * @return array
	 */
	...
	/**
	 * Recherche un jeu dans la base de donnée à partir de l'attribut
	 * 
	 * @param $key string
	 * @return object
	 */
