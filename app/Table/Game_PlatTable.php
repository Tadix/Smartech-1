...
class Game_platTable extends Table {
	...
	/**
	 * Supprime les tuplés de la base de donnée où plat_id est égal à l'attribut id
	 * 
	 * @param $id int
	 * @return boolean
	 */
	...
	/**
	 * Récupère tous les ids des plateformes où l'id des jeux est égal à l'attribut id
	 * 
	 * @param $id int
	 * @return object
	 */
