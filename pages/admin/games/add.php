					...
					if (move_uploaded_file($tmpName, $dest)) {
						...
						if($result) {
							...
							if($resp && $resc) {
								...
								?>
								<div class="danger">
									Erreur : l'article n'a pas été ajouté. Note: Problème lors de l'insertion des/de la plateforme(s) et des/de la catégorie(s).
								</div>
								<?php
							}
						} else {
							?>
							<div class="danger">
								Erreur : l'article n'a pas été ajouté. Note: Problème lors de l'insertion du jeu.
							</div>
							<?php
						}
					} else {
